...
public class NumberUtilTest extends BaseUnitTest {
	...
	public void isNumberInRange_test() {
		...
		SoftAssertUnitTest.assertTrueNow(
				NumberUtil.isNumberInRange(number, min, max),
	...
	public void isNumberInRange_negative_test() {
		...
		SoftAssertUnitTest.assertTrueNow(
				!NumberUtil.isNumberInRange(number, outOfRange, outOfRange),
				"Number [" + number + "] should not be in range of ["
						+ outOfRange + "," + outOfRange +"]",
				"Verify that Number [" + number + "] is not in range of ["
						+ outOfRange + "," + outOfRange + "]");
	}
	...
	public void intToString_test(int number, int digits, String expectedResult) {		
		...
		SoftAssertUnitTest.assertTrueNow(
				...
				"Result of intToString with input number [" + number
						+ "] and digits amount [" + digits + "] is [" + result
						+ "], and should be [" + expectedResult + "]",
				"Verify that result of intToString with input number [" + number
						+ "] and digits amount [" + digits + "] is [" + expectedResult + "]");
	}
}