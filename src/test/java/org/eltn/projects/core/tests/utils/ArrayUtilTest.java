...
public class ArrayUtilTest extends BaseTest {
	...
	public void getIndex_test(String arrElement, int index) {
		int currentIndex = ArrayUtil.getIndex(strArr, arrElement);
	...
	public void isObjectInArray_Test(String element) {
		SoftAssert.assertTrueNow(ArrayUtil.isObjectInArray(strArr, element),
	...
	public void isObjectInArray_Negative_Test(String element) {
		SoftAssert.assertTrueNow(ArrayUtil.isObjectInArray(strArr, element) == false,
