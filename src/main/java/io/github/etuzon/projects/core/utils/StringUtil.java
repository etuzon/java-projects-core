...
public final class StringUtil extends ObjectBase {
	 ...
	 * @return true if String meets at least one of excepts in expect list, else
	 *         return false.
	 */
	...
	/*****************************************
	 * Get String List for all the String elements from 'containList' that are
	 * contained in 'str'.
	 * 
	 * @param str         String
	 * @param containList List of String elements that will be checked if they are
	 *                    contained in 'str'.
	...
	/*****************************************
	 * Replace String templates with input agrs, when template is
	 * {@link #REPLACE_STR}.
	 * 
	 * Example: str = "12345{@link #REPLACE_STR}abc{@link #REPLACE_STR}de"
	 * StringUtil.replace(str, "zxc", "qwe"); output = "12345zxcabcqwede".
	 * 
	 * @param str  String
	 * @param args Arguments that will replace the templates
	 *             'StringUtil.REPLACE_STR'
	 * @return Replaced String
	 * @throws InvalidValueException in case args == null, or there are no args, or
	 *                               the amount of args is different from the amount
	 *                               of {@link #REPLACE_STR} in 'str'.
	 */
	 ...
	 * 
	 * @param str String.
	 * @return Input String without last char. In case input String is empty than
	 ...
	 * @return String of InputStream content.
	 * @throws IOException in case that failed read from InputStream.
	 */
	public static String readFromInputStream(InputStream is) throws IOException {
		...
		int readSize;
		while ((readSize = rd.read(buffer)) != -1) {
			sb.append(String.valueOf(buffer, 0, readSize));
		}
